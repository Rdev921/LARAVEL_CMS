...
<head>
    ...
    <link href="{{url('frontend/css/all.min.css')}}" rel="stylesheet" /> <!-- https://fontawesome.com/ -->
    <link href="{{url('frontend/slick/slick.css')}}" rel="stylesheet" /> <!-- https://kenwheeler.github.io/slick/ -->
    <link href="{{url('frontend/slick/slick-theme.css')}}" rel="stylesheet" />
	<link href="{{url('frontend/css/bootstrap.min.css')}}" rel="stylesheet" /> <!-- https://getbootstrap.com -->
...
<body>
        ...
        <div class="row">
            <div class="col-12">
                <div class="tm-main-bg tm-about-bg">
                <img src="{{url('img/new-vision-02.jpg')}}" alt="Welcome image" />
                </div>        
            </div>
        </div>
