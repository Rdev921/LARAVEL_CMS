...
<head>
    ...
    <link href="{{asset('public/frontend/css/all.min.css')}}" rel="stylesheet" /> <!-- https://fontawesome.com/ -->
    <link href="{{asset('public/frontend/slick/slick.css')}}" rel="stylesheet" /> <!-- https://kenwheeler.github.io/slick/ -->
    <link href="{{asset('public/frontend/slick/slick-theme.css')}}" rel="stylesheet" />
	<link href="{{asset('public/frontend/css/bootstrap.min.css')}}" rel="stylesheet" /> <!-- https://getbootstrap.com -->
	<link href="{{asset('public/frontend/css/templatemo-new-vision.css')}}" rel="stylesheet" />
<!--
...
<body>
        ...
        <main>
            ...
            <section class="tm-featured">
                ...
                <div class="grid tm-carousel">
                    ...
                    <figure class="effect-honey">
                        <img src="{{asset('public/img/gallery-item-08.jp')}}g" alt="Featured Item">
                        <figcaption>
    ...
    <script src="{{asset('public/frontend/js/templatemo-script.js')}}"></script>
</body>
</html>
